...
class AIAssistant:
    ...
    def send_update(self, assigned_pair: Dict, recommendation_id: str, learner_info: Tuple[int, float]) -> Dict:
        ...
        expl = self._create_explanation(ma_id, client_id, recommendation_id, learner_info)
